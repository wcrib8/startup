...
- [x] **Node.js/Express HTTP service** - connected express to use web service
- [x] **Static middleware for frontend** - middleware allows for frontend to be called/delivered from backend
- [x] **Calls to third party endpoints** - third party endpoints are connected and functional, to EmailJS
- [x] **Backend service endpoints** - Backend connected, using fetch elements and calling APIs
- [x] **Frontend calls service endpoints** - using fetch to retrieve backend information
- [x] **Supports registration, login, logout, and restricted endpoint** - users must be authenticated for full access.
